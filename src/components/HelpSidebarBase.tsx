          ...
          >
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-400">Help & Information</h2>
              </div>
              <div className="flex items-center gap-2">
                <button 
                  onClick={() => {
            ...
            {/* Sidebar content */}
            <motion.div 
              className="flex-grow overflow-y-auto px-6 py-4 overflow-y-auto text-gray-900 dark:text-gray-400"
              variants={contentVariants}
            >
              <motion.div className="mb-6" variants={itemVariants}>
                <h3 className="text-xl font-bold mb-2 text-gray-900 dark:text-gray-400">{content.title}</h3>
